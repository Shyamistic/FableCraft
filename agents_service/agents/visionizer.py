"""
Visionizer Agent
Analyzes children's drawings using vision AI
Extracts characters, setting, and artistic style
Then generates a cute animated character using image generation
"""
...
def analyze_and_generate_character(image_uri: str) -> str:
    ...
    try:
        ...
        print("[Visionizer Tool] Step 1: Analyzing drawing with vision AI...")
        ...
        print("[Visionizer Tool] Step 3: Generating character image...")
...
# Agent configuration (legacy ADK structure — will be replaced by native Python orchestration)
VISIONIZER_CONFIG = {
    "name": "visionizer",
    "description": "Analyzes children's drawings and generates animated characters using vision AI and image generation",
    "instruction": """
    You are the Visionizer agent in the Fablecraft pipeline.
    ...
    {"success": true, "analysis": {...}, "generated_character_uri": "s3://..."}
