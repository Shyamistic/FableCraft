"""
Illustrator Agent
Generates scene illustrations for interactive story quests using image generation
...
YOU MUST CALL THE TOOL FUNCTION. The tool will generate REAL images using the image generation API.
"""

# Agent configuration (legacy ADK structure — will be replaced by native Python orchestration)
ILLUSTRATOR_CONFIG = {
    "name": "illustrator",
    "description": "Generates 8 storybook-style scene illustrations using image generation with character consistency",
