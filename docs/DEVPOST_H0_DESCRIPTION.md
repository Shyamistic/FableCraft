...
[![Fablecraft Demo](https://img.youtube.com/vi/NEK5weMjHb4/maxresdefault.jpg)](https://youtu.be/NEK5weMjHb4)

**▶️ Watch:** [https://youtu.be/NEK5weMjHb4](https://youtu.be/NEK5weMjHb4)
...
![Content Safety](https://github.com/Shyamistic/FableCraft/blob/main/docs/pictures/Screenshot%20(5230).png?raw=true)
*Amazon Nova Lite content moderation — keeping the experience safe*
...
No PII stored. Anonymous UUIDs only. No accounts required.
...
| **Family** | $9.99/mo | Up to 4 kids, parent analytics, downloadable storybooks |

**Unit Economics:**
- Cost per quest: ~$0.08 (Bedrock + Polly + S3 + DynamoDB)
- Explorer at 20 quests/month = $1.60 cost → **68% gross margin**
- Target: $7.6B children's educational app market
...
![Future Animation](https://github.com/Shyamistic/FableCraft/blob/main/docs/gifs/gif4-ezgif.com-video-to-gif-converter.gif?raw=true)

Our architecture is ready for **Amazon Nova Reel**:

```
Current:  Drawing → Character → Static Scenes → Audio
Future:   Drawing → Character → Animated Scenes → Audio

8 scenes × 6-second clips = 48-second personalized animated storybook
```

Fablecraft becomes the **first platform to transform a child's drawing into a complete animated short film** — entirely on AWS.
